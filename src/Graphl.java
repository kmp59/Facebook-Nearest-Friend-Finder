...
class Graphl implements Graph, java.io.Serializable 
{
  ...
  public void fastSetEdge(int i, int j, int weight) {
  ...
  public boolean isEdge(int v, int w) {
    ...
    if ((it != null) && (it.vertex() == w))
      return true;
    for (vertex[v].moveToStart(); vertex[v].currPos() < vertex[v].length(); vertex[v]
        .next())
      // Check whole list
